                        ...
                        <div className="bg-white rounded-[30px] border border-gray-100 overflow-hidden">
                            <table className="w-full min-w-[700px]">
                                ...
                                <tbody className="divide-y divide-gray-50">
                                    ...
                                    <tr><td className="py-5 px-8 font-bold">3. หัวหน้าศูนย์ฯ</td><td className="py-5 px-8 text-gray-600">ปฐมนิเทศ</td><td className="py-5 px-8 text-center">5</td><td className="py-5 px-8 text-center"><span className="text-gray-300">Admin ให้คะแนน</span></td></tr>
                                    <tr><td className="py-5 px-8 font-bold">4. กรรมการศูนย์ฯ</td><td className="py-5 px-8 text-gray-600">ปัจฉิมนิเทศ</td><td className="py-5 px-8 text-center">5</td><td className="py-5 px-8 text-center"><span className="text-gray-300">Admin ให้คะแนน</span></td></tr>
                                </tbody>
